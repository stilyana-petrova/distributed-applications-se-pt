...
namespace SongDiaryWebApi.Controllers
{
    ...
    public class ArtistController : ControllerBase
    {
        ...
        {
            var createdArtist = await _artistService.Create(artist.Name, artist.Bio, artist.DateOfBirth);
        ...
        {
            var updated = await _artistService.Update(id, artist.Name, artist.Bio, artist.DateOfBirth);
